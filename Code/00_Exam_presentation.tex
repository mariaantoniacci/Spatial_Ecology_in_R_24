\documentclass{beamer} % Presentation in Latex
\usepackage{graphicx} % Required for inserting images
\usepackage{hyperref} % Hypertext link 

\usetheme{Frankfurt} % style 
\usecolortheme{spruce} % color
...
\end{frame}
} % To see outline at evry new section

\section{Introduction} % 1° section

\begin{frame}{2023 Wildfires in Greece}

\begin{columns} % To have more than one
